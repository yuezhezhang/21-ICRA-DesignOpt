...
deform_mount0 (pandaMount) { joint:rigid } #joint:transXY, constant }
...
Edit deform8 { joint:free, constant, limits:[-.05 .05 -.05 .05 -.05 .05 .8 1.05 -.3 .3 -.3 .3 -.3 .3] }

screwMount (pandaTable) { }
deform_mount8 (screwMount) { Q:< t(0. .15 .05)>, joint:trans3, constant, limits:[-.5 .5 -.2 .2 .0 .2] } # .8 1.05 -.2 .2 -.2 .2 -.2 .2] }
screwTable (deform_mount8) { shape:ssBox,, size:[.5 .3 .05 .02], color:[.3 .3 .3]}
bolt (screwTable) { Q:<t(.0 .0 0)>,   joint:rigid,  mesh:'../scenarios/wrench/bolt.ply', color:[.9 .9 .9]  }
boltTip(screwTable) { Q:<t(.0 .0 0) t(.013 0 .12) d(30 0 0 1)>shape:marker, size:[.03], color:[.9 .9 .5] }
